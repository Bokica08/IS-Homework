...
using MovieShop.Repository.Implementation;
...
namespace MovieShop.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITicketService, TicketServiceImpl>();
            services.AddTransient<IShoppingCartService, ShoppingCartServiceImpl>();
